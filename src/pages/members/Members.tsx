...
import { MembersColumns } from "../../components/models/columns";
...
function Members() {
  ...
  const { members, isError, isSucces, isLoading, message } = useSelector(
    (state: any) => state.members
  );

  const { user } = useSelector((state: any) => state.auth);

  let memberData: MemberModel[] = members as MemberModel[];

...
export const add = createAsyncThunk (
  ...
  async (department: DepartmentModel, thunkAPI) => {
    try {
      return await departmentService.add(department, user.access_token.toString());
    } catch (error: any) {
      const message =
        (error.response &&
          error.response.data &&
...
export const deleteById = createAsyncThunk (
  ...
  async (id : number, thunkAPI) => {
    try {
      return await departmentService.deleteById(user.access_token,id);
    } catch (error: any) {
      const message =
        (error.response &&
          error.response.data &&
...
export const updateById = createAsyncThunk (
  ...
  async (department : Partial<DepartmentModel>, thunkAPI) => {
    try {
      ...
      return await departmentService.updateById(user.access_token,id!, fields);
    } catch (error: any) {
      const message =
        (error.response &&
          error.response.data &&
...
export const findById = createAsyncThunk (
  ...
  async (id : number, thunkAPI) => {
    try {
      ...
      return await departmentService.findByID(user.access_token, id);
    } catch (error: any) {
      const message =
        (error.response &&
          error.response.data &&
